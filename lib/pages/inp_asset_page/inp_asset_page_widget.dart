import '/components/coordinate_list_widget.dart';
...
import 'inp_asset_page_model.dart';
export 'inp_asset_page_model.dart';

class InpAssetPageWidget extends StatefulWidget {
  const InpAssetPageWidget({super.key});

  @override
  State<InpAssetPageWidget> createState() => _InpAssetPageWidgetState();
}

class _InpAssetPageWidgetState extends State<InpAssetPageWidget> {
  late InpAssetPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InpAssetPageModel());
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    'Masukkan data asset, atau coba convert dari *.kml shapefile anda.',
                    maxLines: 2,
                    style: FlutterFlowTheme.of(context).headlineMedium.override(
                          fontFamily: 'Outfit',
                          color: FlutterFlowTheme.of(context).primaryText,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            FlutterFlowRadioButton(
                              options:
                                  ['Digunakan', 'Tidak Digunakan'].toList(),
                  ...
                  wrapWithModel(
                    model: _model.coordinateListModel,
                    updateCallback: () => setState(() {}),
                    child: const CoordinateListWidget(),
                  ),
                ],
              ),
            ),
